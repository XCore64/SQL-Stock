...
CREATE TABLE Client
             (Tax_ID            VARCHAR2(11)          NOT NULL,
	      Client_Name       VARCHAR2(30)    ,
	      Client_Address    VARCHAR2(26)    ,
              Client_City       VARCHAR2(13)    ,              
              Client_State      VARCHAR2(2)     ,
              Client_Zip        NUMBER     ,
CONSTRAINT CLIENT_PK PRIMARY KEY (Tax_ID));

CREATE TABLE Stock
             (Ticker_Symbol		VARCHAR2(4)          NOT NULL,
	      Company_Name       	VARCHAR2(30)   ,
	      Stock_Rating    		VARCHAR2(1)    ,
              Stock_Business       	VARCHAR2(25)   ,              
...
CREATE TABLE Fund_Family
	      ...
	      Company_City	 VARCHAR2(10)	,
	      Company_State	 VARCHAR2(2)	,
	      Company_Zip	 VARCHAR2(5)	,
CONSTRAINT FUND_FAMILY_PK PRIMARY KEY (Fund_ID));

CREATE TABLE Mutual_Fund
             (M_TickerSymbol       VARCHAR2(5)          NOT NULL,
	      Fund_Name       	   VARCHAR2(10)      ,
	      Fund_Type       	   VARCHAR2(15)      ,            
...
CREATE TABLE Fund_Portfolio
             (Tax_ID      	VARCHAR2(11)     NOT NULL,
	      M_TickerSymbol    VARCHAR2(30)    	NOT NULL,
...
CREATE TABLE Stock_Portfolio
             (Tax_ID      	VARCHAR2(11)          NOT NULL,
	      Ticker_Symbol     VARCHAR2(30)          NOT NULL,
	      NumOfShares    	NUMBER    		     ,
